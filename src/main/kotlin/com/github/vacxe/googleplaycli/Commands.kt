...
object Commands {
    object Apks {
        class List : EditCommand(
            name = "list",
            actionDescription = "Lists all current APKs for the specified package and edit"
        ) {
    ...
    object Bundles {
        ...
        class Upload :
            EditCommand(name = "upload", actionDescription = "Uploads a new Android App Bundle to this edit") {
            private val bundle: File by option("--bundle", "-b", help = "Bundle file path").file().required()
            private val ackBundleInstallationWarning: Boolean by option(
                "--ack-bundle-installation-warning",
                "-a",
                help = "Must be set to true if the bundle installation may trigger a warning on user devices (for example, if installation size may be over a threshold, typically 100 MB)."
            )
                .flag(default = false)

            private val deviceTierConfigId: String? by option(
                "--device-tier-config-id",
                "-t",
                help = "Device tier config (DTC) to be used for generating deliverables (APKs). Contains id of the DTC or \"LATEST\" for last uploaded DTC."
            )

            override fun run(api: PlayStoreApi) = api.bundlesUpload(
                BundlesUploadModel(
                    packageName,
                    editId,
                    bundle,
    ...
    object Deobfuscationfiles {
        class Upload : EditCommand(
            name = "upload",
            actionDescription = "Uploads the deobfuscation file of the specified APK. If a deobfuscation file already exists, it will be replaced"
        ) {
            ...
            private val deobfuscationFileType: String by option(
                "--deobfuscation-file-type",
                "-t",
                help = "Acceptable values are: proguard, nativeCode"
            )
                .choice("proguard", "nativeCode")
                .default("proguard")

            override fun run(api: PlayStoreApi) = api.deobfuscationFilesUpload(
    ...
    object Details {
        class Get : EditCommand(
            name = "get",
            actionDescription = "Fetches app details for this edit. This includes the default language and developer support contact information"
        ) {
        ...
        class Patch : EditCommand(name = "patch", actionDescription = "Updates app details for this edit") {
            private val contactEmail: String? by option(
                "--contact-email",
                "-e",
                help = "The user-visible support email for this app"
            )
            private val contactPhone: String? by option(
                "--contact-phone",
                help = "The user-visible support telephone number for this app"
            )
            private val contactWebsite: String? by option(
                "--contact-website",
                "-w",
                help = "The user-visible website for this app"
            )
            private val defaultLanguage: String? by option(
                "--default-language",
                "-l",
                help = "Default language code, in BCP 47 format (eg \"en-US\")."
            )

            override fun run(api: PlayStoreApi) = api.detailsPatch(
                DetailsPatchModel(
                    packageName,
                    editId,
                    contactEmail,
        ...
        class Update : EditCommand(name = "update", actionDescription = "Updates app details for this edit") {
            ...
            override fun run(api: PlayStoreApi) = api.detailsUpdate(
                DetailsUpdateModel(
                    packageName,
                    editId,
                    contactEmail,
    ...
    object DeviceTiersConfigs {
        class Get : EditCommand(name = "get", actionDescription = "Returns a particular device tier config") {
            private val deviceTierConfigId: String by option(
                "--device-tier-config-id",
                "-t",
                help = "Id of an existing device tier config"
            )
                .required()

            override fun run(api: PlayStoreApi) = api.deviceTierConfigsGet(
                DeviceTierConfigsGetModel(
                    packageName,
                    deviceTierConfigId.toLong(),
                    parameters
                )
            )
        }
        ...
        class List : EditCommand(
            name = "list",
            actionDescription = "Returns created device tier configs, ordered by descending creation time"
        ) {
            override fun run(api: PlayStoreApi) =
                api.deviceTierConfigsList(DeviceTierConfigsListModel(packageName, parameters))
        }
    }
    ...
    object ExpansionFiles {
        class Get : EditCommand(
            ...
            override fun run(api: PlayStoreApi) = api.expansionFilesGet(
        ...
        class Patch : EditCommand(
            ...
            override fun run(api: PlayStoreApi) = api.expansionFilesPatch(
        ...
        class Update : EditCommand(
            ...
            override fun run(api: PlayStoreApi) = api.expansionFilesUpdate(
        ...
        class Upload : EditCommand(
            ...
            private val expansionFileType: String by option("--expansion-file-type", "-t").choice("main", "patch")
                .default("main")
            private val expansionFile: File by option("--expansion-file", "-f", help = "Expansion file patch").file()
                .required()

            override fun run(api: PlayStoreApi) = api.expansionFilesUpload(
    ...
    object Images {
        class List : EditCommand(
            name = "list",
            actionDescription = "Lists all images for the specified language and image type"
        ) {
            ...
            val language: String by option(
                "--language",
                "-l",
                help = "The language code (a BCP-47 language tag) of the localized listing whose images you want to list. For example, to select Latin American Spanish, pass \"es-419\"."
            ).required()


            override fun run(api: PlayStoreApi) =
                api.imagesList(ImagesListModel(packageName, editId, imageType, language, parameters))
        }

        class Delete :
            EditCommand(name = "delete", actionDescription = "Deletes the image (specified by id) from the edit") {
            private val imageType: String by option("--image-type", "-t")
                .choice(
                    "featureGraphic",
                    "icon",
            ...
            override fun run(api: PlayStoreApi) =
                api.imagesDelete(ImagesDeleteModel(packageName, editId, imageType, language, imageId, parameters))
        }

        class DeleteAll : EditCommand(
            name = "delete-all",
            actionDescription = "Deletes all images for the specified language and image type"
        ) {
            private val imageType: String by option("--image-type", "-t")
                .choice(
                    "featureGraphic",
            ...
            override fun run(api: PlayStoreApi) =
                api.imagesDeleteAll(ImagesDeleteAllModel(packageName, editId, imageType, language, parameters))
        }

        class Upload : EditCommand(
            name = "upload",
            actionDescription = "Uploads a new image and adds it to the list of images for the specified language and image type"
        ) {
            ...
            override fun run(api: PlayStoreApi) =
                api.imagesUploadAll(ImagesUploadModel(packageName, editId, imageType, language, image, parameters))
        }
    }

    object Listings {
        class DeleteAll :
            EditCommand(name = "deleteAll", actionDescription = "Deletes all localized listings from an edit") {
            override fun run(api: PlayStoreApi) = api.listingsDeleteAll(EditModel(packageName, editId, parameters))
        }

        class List : EditCommand(
            name = "list",
            actionDescription = "Returns all of the localized store listings attached to this edit"
        ) {
            override fun run(api: PlayStoreApi) = api.listingsList(EditModel(packageName, editId, parameters))
        }

        class Get :
            EditCommand(name = "get", actionDescription = "Fetches information about a localized store listing") {
            val language: String by option(
                "--language",
                "-l",
                help = "The language code (a BCP-47 language tag) of the localized listing to read or modify. For example, to select Latin American Spanish, pass \"es-419\"."
            ).required()

            override fun run(api: PlayStoreApi) =
                api.listingsGet(ListingsGetModel(packageName, editId, language, parameters))
        }

        class Delete : EditCommand(
            name = "delete",
            actionDescription = "Deletes the specified localized store listing from an edit"
        ) {
            val language: String by option(
                "--language",
                "-l",
            ...
            override fun run(api: PlayStoreApi) =
                api.listingsDelete(ListingsDeleteModel(packageName, editId, language, parameters))
        }

        class Update :
            EditCommand(name = "update", actionDescription = "Creates or updates a localized store listing") {
            val language: String by option(
                "--language",
                "-l",
                help = "The language code (a BCP-47 language tag) of the localized listing to read or modify. For example, to select Latin American Spanish, pass \"es-419\"."
            ).required()
            private val fullDescription: String by option(
                "--full-description",
                "-d",
                help = "Full description of the app; this may be up to 4000 characters in length."
            ).default("").validate { it.length <= 4000 }
            private val shortDescription: String by option(
                "--short-description",
                "-s",
                help = "Short description of the app (previously known as promo text); this may be up to 80 characters in length."
            ).default("").validate { it.length <= 80 }
            private val title: String by option("--title", "-t", help = "App's localized title.").default("")
            private val video: String by option(
                "--video-url",
                "-v",
                help = "URL of a promotional YouTube video for the app."
            ).default("")

            override fun run(api: PlayStoreApi) = api.listingsUpdate(
                ListingsUpdateModel(
                    packageName,
                    editId,
                    language,
        ...
        class Patch : EditCommand(name = "patch", actionDescription = "Creates or updates a localized store listing") {
            ...
            override fun run(api: PlayStoreApi) = api.listingsPatch(
                ListingsPatchModel(
                    packageName,
                    editId,
                    language,
    ...
    object Testers {
        class Get : EditCommand(name = "get") {
            ...
            override fun run(api: PlayStoreApi) =
                api.testersGet(TestersGetModel(packageName, editId, track, parameters))
        }
        ...
        class Update : EditCommand(name = "update") {
            ...
            override fun run(api: PlayStoreApi) =
                api.testersUpdate(TestersUpdateModel(packageName, editId, track, googleGroups, parameters))
        }
        ...
        class Patch : EditCommand(name = "patch") {
            ...
            override fun run(api: PlayStoreApi) = api.testersPatch(
                TestersPatchModel(
                    packageName,
                    editId,
                    track,
    ...
    object Tracks {
        class List :
            EditCommand(name = "list", actionDescription = "Lists all the track configurations for this edit") {
            override fun run(api: PlayStoreApi) = api.tracksList(EditModel(packageName, editId, parameters))
        }

        class Get : EditCommand(
            name = "get",
            actionDescription = "Fetches the track configuration for the specified track type. Includes the APK version codes that are in this track"
        ) {
            private val track: String by option("--track", "-t").required()
    ...
    object Reviews {
        class List : EditCommand(
            name = "list",
            actionDescription = "Returns a list of reviews. Only reviews from last week will be returned"
        ) {
            ...
            override fun run(api: PlayStoreApi) = api.reviewsList(
                ReviewsListModel(
                    packageName,
                    editId,
                    maxResults,
        ...
        class Get : EditCommand(name = "get", actionDescription = "Returns a single review") {
            ...
            override fun run(api: PlayStoreApi) =
                api.reviewsGet(ReviewsGetModel(packageName, editId, reviewId, translationLanguage, parameters))
        }

        class Reply :
            EditCommand(name = "reply", actionDescription = "Reply to a single review, or update an existing reply") {
            private val reviewId: String by option("--review-id", "-r").required()
            private val replyText: String by option("--reply-text", "-a").required()

            override fun run(api: PlayStoreApi) =
                api.reviewsReply(ReviewsReplyModel(packageName, editId, reviewId, replyText, parameters))
        }
    }
    ...
    object Orders {
        class Refund :
            EditCommand(name = "refund", actionDescription = "Refund a user's subscription or in-app purchase order") {
            private val orderId: String by option(
                "--order-id",
                "-o",
                help = "The order ID provided to the user when the subscription or in-app order was purchased"
            ).required()
            private val revoke: Boolean by option(
                "--revoke",
                "-l",
                help = "Whether to revoke the purchased item. If set to true, access to the subscription or in-app item will be terminated immediately. If the item is a recurring subscription, all future payments will also be terminated. Consumed in-app items need to be handled by developer's app. (optional)"
            ).flag()

            override fun run(api: PlayStoreApi) =
                api.ordersRefund(OrdersRefundModel(packageName, editId, orderId, revoke, parameters))
        }
    }
    ...
    object Inappproducts {
        ...
        class Delete : BaseCommand(name = "delete", actionDescription = "Delete an in-app product for an app") {
            private val sku: String by option(
                "--sku",
                "-s",
                help = "Unique identifier for the in-app product"
            ).required()
        ...
        class Get :
            BaseCommand(name = "get", actionDescription = "Returns information about the in-app product specified") {
            private val sku: String by option(
                "--sku",
                "-s",
                help = "Unique identifier for the in-app product"
        ...
        class Insert : BaseCommand(name = "insert", actionDescription = "Creates a new in-app product for an app") {
            private val jsonPath: Path by option("--file", "-f", help = "Json file path").path(
                mustExist = true,
                canBeDir = false
            ).required()
            private val autoConvertMissingPrices: Boolean by option(
                "--auto-convert-missing-prices", "-a", help = """
        ...
        class Patch : BaseCommand(
            name = "patch",
            actionDescription = "Updates the details of an in-app product. This method supports patch semantics"
        ) {
            private val sku: String by option(
                "--sku",
                "-s",
